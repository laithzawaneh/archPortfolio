package com.archPortfolio.archPortfolio.archsecurity;
...
@Configuration
public class ArchSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests(configurer -> configurer.requestMatchers("/images/**").permitAll().requestMatchers("/mainhome","/getImagesByProjectId").permitAll().requestMatchers("/").hasRole("ADMIN")
